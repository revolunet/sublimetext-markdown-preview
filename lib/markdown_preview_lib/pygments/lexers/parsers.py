...
from ..lexers.compiled import JavaLexer, CLexer, CppLexer, \
    ObjectiveCLexer, DLexer
from ..lexers.dotnet import CSharpLexer
from ..lexers.agile import RubyLexer, PythonLexer, PerlLexer
from ..lexers.web import ActionScriptLexer
