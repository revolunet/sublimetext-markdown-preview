...
Markdown Preview provides a generalized script in `Markdown Preview/js/math_config.js`. It searches for `$...$`, `$$...$$`, `\(...\)`, and `\[...\]`. You can change this to only target what you want by creating your own.
